  ...
  <Layout>
    <Box p={5}>
      ...
      <Text mt={4} color={"primary"}>
        ...
        Our experts are here to ensure the highest quality in building wall
        panels for large construction projects such as apartment buildings,
        condos, and more.
      </Text>
      <Text mt={4} color={"primary"}>
        At SBC, we are deeply committed to supporting our employees, fostering a
        positive and empowering workplace. Our mission is to uplift and provide
        growth opportunities for every team member, ensuring their well-being
        and professional development. We pride ourselves on our dedication to
        excellence and our focus on creating a collaborative environment where
        our employees can thrive.
      </Text>
      <Text mt={4} color={"primary"}>
        We take immense pride in our strong community of professionals who are
        at the heart of everything we do. Located in Sedro Woolley, WA, SBC
        continues to innovate and lead in the construction industry, always
